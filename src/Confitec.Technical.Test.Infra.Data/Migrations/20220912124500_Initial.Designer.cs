...
namespace Confitec.Technical.Test.Infra.Data.Migrations
{
    ...
    [Migration("20220912124500_Initial")]
            ...
            modelBuilder.Entity("Confitec.Technical.Test.Domain.ParametersModule.Parameter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Key = "SIDE_BAR_TYPE",
                            LastDateUpdated = new DateTime(2022, 9, 12, 9, 45, 0, 492, DateTimeKind.Local).AddTicks(1077),
                            Value = "1"
                        },
                        new
                        {
                            ID = 2,
                            Key = "SESSION_TIME",
                            LastDateUpdated = new DateTime(2022, 9, 12, 9, 45, 0, 492, DateTimeKind.Local).AddTicks(1081),
                            Value = "120"
                        });
                });
            ...
            modelBuilder.Entity("Confitec.Technical.Test.Domain.SystemUserModule.SystemUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateDate = new DateTime(2022, 9, 12, 9, 45, 0, 492, DateTimeKind.Local).AddTicks(972),
